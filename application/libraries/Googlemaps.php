...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCU52yO3et-Pai_KaFuLFc5H4VJ1zQj0Zc'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $backgroundColor			= '#00BCD4';						// A hex color value shown as the map background when tiles have not yet loaded as the user pans
	...
	var $center						= "28.7041, 77.1025";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	function __construct($config = array())
{
	...
	function add_polyline($params = array())
	{
		...
		$polyline['strokeColor'] = '##5A4596';					// The hex value of the polylines color
		$polyline['strokeOpacity'] = '1.0';						// The opacity of the polyline. 0 to 1.0
		$polyline['strokeWeight'] = '4';						// The thickness of the polyline
