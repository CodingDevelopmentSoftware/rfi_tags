                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" onsubmit="return confirm('Are you sure you want to Proceed ?');" action="<?= base_url()?>Vehicle_controller/vehicle_wise">
                                            

                                             <div class="form-group">
                                                <label>Vehicle Tag *</label>
                                                <input type="text" name="vehicle_tag" class="form-control" placeholder="Enter Vehicle Tag" value="<?php echo  set_value('vehicle_tage',$this->session->userdata('vehicle_tage'),FALSE);?>" required=""/>
                                        ...
                                        <br/>
                                    <table class="table table-striped table-bordered table-hover" id="vehicle_wise">
                                        <thead>
                                            <tr>
                                                <th>Serial No.</th>
