                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" onsubmit="return confirm('Are you sure you want to Proceed ?');" action="<?= base_url()?>Vehicle_controller/location_wise">
                                            <div class="form-group">
                                                <label>Location Name - Location Type - Area *</label>
                                                <select name="location_id" class="form-control" required="">
                                                    <option value="">Select Location</option>
                                                    <?php foreach($page_data as $page_data){?>
                                                           <option value="<?= $page_data->location_id?>" <?php echo set_select('location_id', $page_data->location_id, False); ?>><?= ucwords($page_data->location_name);?>- <?php if($page_data->location_type=='i'){echo "In";}else{echo "Out";}?> - <?= ucwords($page_data->area_name);?></option> 
                                                    <?php }?>    
                                                    option
                                                </select>
                                                <?php ?>
                                        ...
                                        <br/>
                                    <table class="table table-striped table-bordered table-hover" id="location_wise">
                                     <thead>
                                            <tr>
                                                <th>Serial No.</th>
