                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" onsubmit="return confirm('Are you sure you want to Proceed ?');" action="<?= base_url()?>Vehicle_controller/device_wise">
                                            <div class="form-group">
                                                <label>Device Name (Device Id) *</label>
                                                <select name="device_id" class="form-control" required="">
                                                    <option value="">Select Device</option>
                                                    <?php foreach($page_data as $page_data){?>
                                                           <option value="<?= $page_data->device_id_number?>" <?php echo set_select('device_id', $page_data->device_id_number, False); ?> ><?= $page_data->device_name." (".$page_data->device_id_number.")";?></option> 
                                                    <?php }?>    
                                                    option
                                                </select>
                                                <?php ?>
                                        ...
                                        <br/>
                                    <table class="table table-striped table-bordered table-hover" id="device_wise">
                                        <thead>
                                            <tr>
                                                <th>Serial No.</th>
