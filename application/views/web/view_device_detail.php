                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr><td>Device Name</td><td><b><?= $page_data->device_name;?></b></td></tr>
                                            <tr><td>Device id</td><td><b><?= $page_data->device_id_number;?></b></td></tr>
                                                <tr><td>Status</td>
                                                <td>
                                                    <b>
                                            ...
                                            <tr><td>Added Date</td><td><b><?= date("d D/Y/M - H:i:s",strtotime($page_data->created_dt));?></b></td></tr>
                                            <?php 
                                                ...
                                                {?>
                                                    ...
                                                    <tr><td>Modified Date</td><td><b><?= date("d D/Y/M - H:i:s",strtotime($page_data->modified_dt));?></b></td></tr>
                                            <?php }?>
