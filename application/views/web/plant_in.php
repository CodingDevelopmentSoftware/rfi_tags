                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" onsubmit="return confirm('Are you sure you want to Proceed ?');" action="<?= base_url()?>Vehicle_controller/plant_in">
                                        ...
                                        <br/>
                                    <table class="table table-striped table-bordered table-hover" id="plant_in">
                                        <thead>
                                            <tr>
                                                <th>Serial No.</th>
                                                ...
                                                <th>Location Name</th>
                                                <th>Location Type</th> 
                                                <th>Transaction Date (B) Plant In</th> 
                                                <th>Time Difference (B-A)</th> 
                                            </tr>
                                        </thead>
                                        <tbody>
