                        ...
                        <form role="form" method="post" action="<?= base_url('login/check') ?>" autocomplete="off">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control phone_number" placeholder="Enter Phone Number" name="phone_number" required="" id="phone_number" min="1" maxlength="10" minlength="10" autofocus>
                                </div>
                                <div class="form-group">
