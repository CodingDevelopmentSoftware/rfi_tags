...
class Vehicle_controller extends MY_Controller
{
	...
	public function index()
	{
		...
		{
			return redirect('Vehicle_controller/dashboard');
		}
		if(isset($_POST['login']))
		{
			$this->Vehicle_admin->login_model();
		}	
	...
	public function my_profile()
	{
		...
		$data=array(
			'title'=>'My Profile',
			'page_data'=>$this->Vehicle_admin->my_profile()
			);
		$this->load->view('web/my_profile',$data);
	}
	public function update_profile()
	{
		...
		{
			$this->Vehicle_admin->update_admin_profile();
		}	
		$data=array(
			'title'=>'Edit Profile',
			'page_data'=>$this->Vehicle_admin->my_profile()
			);
		$this->load->view('web/update_profile',$data);
	...
	public function change_password()
	{
		...
		{
			$this->Vehicle_admin->change_password_admin();
		}	
		$data=array(
	...
	public function logout()
	{
		...
		$this->session->unset_userdata(['user_id','user_name','email','code_email_id','type']);
	...
	public function dashboard()
	{
		...
		$data=array(
			'title'=>'Dashboard',
			'dashboard_data'=>$this->Vehicle_admin->dashboard(),
			);
